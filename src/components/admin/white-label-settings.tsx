...
const whiteLabelSchema = z.object({
  ...
  seoKeywords: z.string().optional(),
    socialLinks: z.string().optional(),  contactInfo: z.string().optional(),  currency: z.string().optional(),  timezone: z.string().optional(),  dateFormat: z.string().optional(),  timeFormat: z.enum(['12h', '24h']).optional(),  language: z.string().optional(),  taxRate: z.coerce.number().min(0).max(100).optional(),
